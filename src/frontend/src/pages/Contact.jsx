          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <h2 className="section-title mb-2">Limra Diagnostic Center</h2>
            ...
            <div className="space-y-6">
              {/* Google Maps Embed */}
              <div className="rounded-2xl overflow-hidden shadow-medical border border-border h-64">
                <iframe
                  title="Limra Sonography Center Location"
                  src="https://maps.google.com/maps?q=Limra+Sonography+Center+Pune+Maharashtra&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                ...
                {submitted ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      during consultation hours. Please keep your phone
                      available.
                    </p>
                  </div>
                ) : (
