...
const buffer_ts_1 = require("./buffer.js");
const bigint_math_ts_1 = require("./bigint-math.js");
function eob() {
...
function lebEncode(value) {
    ...
    const byteLength = (value === BigInt(0) ? 0 : (0, bigint_math_ts_1.ilog2)(value)) + 1;
    const pipe = new buffer_ts_1.PipeArrayBuffer(new Uint8Array(byteLength), 0);
    while (true) {
...
function writeIntLE(value, byteLength) {
    value = BigInt(value);
    const pipe = new buffer_ts_1.PipeArrayBuffer(new Uint8Array(Math.min(1, byteLength)), 0);
    let i = 0;
    let mul = BigInt(256);
    let sub = BigInt(0);
