 ...
 */
export declare function isV2ResponseBody(body: v2ResponseBody | v3ResponseBody | null): body is v2ResponseBody;
 ...
 */
export declare function isV3ResponseBody(body: v2ResponseBody | v3ResponseBody | null): body is v3ResponseBody;
...
export interface Agent {
     ...
     */
    readState(effectiveCanisterId: Principal | string, options: ReadStateOptions, identity?: Identity, request?: unknown): Promise<ReadStateResponse>;
