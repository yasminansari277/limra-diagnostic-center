...
const index_ts_1 = require("./agent/http/index.js");
const actor_ts_1 = require("./actor.js");
/**
...
async function fetchCandid(canisterId, agent) {
    if (!agent) {
        ...
        agent = await index_ts_1.HttpAgent.create();
    }
    ...
    const actor = actor_ts_1.Actor.createActor(tmpHackInterface, { agent, canisterId });
